...
contract('Minting', function () {
    ...
    it('creates a valid token with the sender as treasurer and auto-renew-account', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    contractId = _d.sent();
                    return [4 /*yield*/, (0, hashgraphQueries_1.createToken)(contractId, tokenData, client, MintingContractAbi)];
                case 4:
    ...
    it('mints multiple nfts on the provided token and assigns it to the sender', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('creates a token and mints multiple nfts in one call', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    _d.trys.push([2, 8, , 9]);
                    return [4 /*yield*/, (0, hashgraphQueries_1.createTokenAndMintMultipleNfts)(contractId, createTokenAndMintMultipleNFTsData, client, MintingContractAbi)];
                case 3:
                    tokenId = (_d.sent())[0];
                    _a = [];
