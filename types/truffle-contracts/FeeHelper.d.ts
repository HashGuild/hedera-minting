...
export interface FeeHelperContract extends Truffle.Contract<FeeHelperInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<FeeHelperInstance>;
}

type AllEvents = never;

export interface FeeHelperInstance extends Truffle.ContractInstance {
  /**
