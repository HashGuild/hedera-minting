...
export interface ExpiryHelperContract
  extends Truffle.Contract<ExpiryHelperInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ExpiryHelperInstance>;
}

type AllEvents = never;

export interface ExpiryHelperInstance extends Truffle.ContractInstance {
  /**
