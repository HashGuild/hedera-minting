...
export interface HederaTokenServiceContract
  extends Truffle.Contract<HederaTokenServiceInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<HederaTokenServiceInstance>;
}

type AllEvents = never;

export interface HederaTokenServiceInstance extends Truffle.ContractInstance {
  /**
