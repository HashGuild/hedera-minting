...
const AttachWalletSection = function ({
      ...
      <>
        ...
        <div className="flex flex-col font-normal text-sm text-slate-500 gap-y-4">
          <div className="flex flex-col text-center gap-5 my-5">
            <div>
              <svg
                className="inline mr-2 w-12 h-12 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300"
                viewBox="0 0 100 101"
                fill="none"
  ...
  return (
    <>
      ...
      {currentOption === 1 && (
        <div className="flex flex-col font-normal text-sm text-slate-500 gap-y-4">
          <p className="mb-4">This is the preferred option on Desktop.</p>
          <p>
          ...
          <p>
            4. Step: <strong>Confirm Smart Contract Execution Event</strong>
          </p>
        </div>
      )}
      {currentOption === 2 && (
